...
* (Optional) Set **info.output_dir: YOUR_OUTPUT_DIR**
...
* Set trainer.pretrained_models.pretrained_video_mamba_3d_model: PATH_OF_THE_PTH_FILE
  * PATH_OF_THE_PTH_FILE is the absolute or relative (to the main path of this project) path of the pre-trained model checkpoint file ('.pth') saved in YOUR_PRETRAIN_OUTPUT_DIR.
...
# TRAIN_CFG_PATH is the absolute or relative (to the main path of this project) path of the `cfg.yaml` file in your YOUR_FINETUNE_OUTPUT_DIR
